...
const { namespace, topicName, subscriptionName } = require("./loadenv");
...
async function main() {
  try {
    ...
    // Start listening
    console.log(
      `Start listening, topicName: ${topicName},  subscriptionName: ${subscriptionName}`
    );
    await senderService.startListening(topicName, subscriptionName);
